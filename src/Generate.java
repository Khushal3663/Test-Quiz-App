...
class Generate implements ActionListener{
   ...
   // Choice c2 = new Choice();
	...
	Generate(){
        ...
        generate.setTitle("Generate");
        generate.setLocation(343, 0);
        generate.setSize(800,800);
        generate.setBackground(clrb);
        generate.addWindowListener(new MyWindowAdapter());
	}
	...
	public static String SubjectName(){
        if(subjectName.equals("Technology")) //for Technology
            subjectName = "Technology";
        else if(subjectName.equals("Indian Geogrophy"))  //for Indian Geogrophy
            subjectName = "Indian Geogrophy";
        else
